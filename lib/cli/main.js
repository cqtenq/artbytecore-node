...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `artbytecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ artbytecore-node add artbyte-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ artbytecore-node remove artbyte-api');
      console.log();
    });
