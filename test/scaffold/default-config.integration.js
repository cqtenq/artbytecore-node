  ...
  it('will return expected configuration', function() {
    var config = JSON.stringify({
      ...
      servicesConfig: {
        bitcoind: {
          spawn: {
            datadir: process.env.HOME + '/.artbytecore/data',
    ...
    var defaultConfig = proxyquire('../../lib/scaffold/default-config', {
      fs: {
        ...
        writeFileSync: function(path, data) {
          path.should.equal(process.env.HOME + '/.artbytecore/artbytecore-node.json');
    ...
    info.path.should.equal(home + '/.artbytecore');
    ...
    bitcoind.spawn.datadir.should.equal(home + '/.artbytecore/data');
